...
import org.app.network.ReadTxt;
...
public class Config {
	...
	public static final String CA_ORG1_URL = "http://" + ReadTxt.ip_port.get(1) + ":" + ReadTxt.ip_port.get(2);
	
	public static final String ORDERER_URL = "grpc://" + ReadTxt.ip_port.get(4) + ":" + ReadTxt.ip_port.get(5);
