...
public class InvokeChaincode {
    ...
    public void invokeInit(){
        try {
            ...
            Peer peer = fabClient_invoke.getInstance().newPeer("peer0.org1.example.com", "grpc://10.108.151.30:7051");
    ...
    public static void main(String[] args) throws JSONException {
        ...
        jsonObject0.put("identifier", "bupt");
        jsonObject0.put("syn_data", "10.20.30.40");
        jsonObject0.put("id_type", "dns");
        jsonObject0.put("root_id", "10");

        new InvokeChaincode().invoke("initIdentity", jsonObject0);
