...
public class InvokeChaincode1 {
    ...
    public void invokeInit(){
        try {
            ...
            Peer peer = fabClient_invoke.getInstance().newPeer("peer1.org1.example.com", "grpc://10.108.148.74:7051");
    ...
    public static void main(String[] args) throws JSONException {
        ...
        jsonObject1.put("identifier", "fnl");
        jsonObject1.put("syn_data", "10xxx/21");
        jsonObject1.put("id_type", "handle");
        jsonObject1.put("root_id", "20");

        new InvokeChaincode1().invoke("initIdentity", jsonObject1);
